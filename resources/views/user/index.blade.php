    ...
    <div class="row">
        ...
        <div class="col-md-2 offset-5 dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li>
                    <a class="dropdown-item" href="{{ route('createList') }}">Add students</a>
                </li>
                <div class="dropdown-divider"></div>
                <li>
                    <a class="dropdown-item" href="{{ route('users.create') }}">Add Admin</a>
                </li>
                <div class="dropdown-divider"></div>
                <li>
                    <a class="dropdown-item" href="{{ route('groups.index') }}">Klas Pagina</a>
                </li>
            </ul>
        </div>
    </div>
