...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Softskills D&D : 1. Your Character</title>
        ...
        <div class="container" id="container">
            ...
            <div id="formfields" class="row mt-4">
                <div id="formfields" class="col-12 mb-3">
                    <form action="abilities.html" id="form">
                        <div class="form-group">
                            <label for="race">Wat is het karaker?</label>
                            <div class="form-row"> 
                                <div class="col">
                                    <input type="text" id="gender" name="gender" class="form-control" placeholder="Geslacht">
                                </div> 
                                <div class="col">
                                    <select class="form-control" name="race" id="race"></select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row mt-2"> 
                                ...
                                <div class="col">
                                    <input type="interger" id="weigth" name="weigth" class="form-control" placeholder="Gewicht (kg)">
                                </div>
                            </div>
                            <div class="form-row mt-2"> 
                                <div class="col">
                        ...
                        <button id="next" class="btn btn-primary">Jouw eigenschappen &rArr;</button>
                    </form>
                </div>
            </div>
        </div>
